...
function addGB(gameboyDiv) {
	var romUrl = 'https://cors-anywhere.herokuapp.com/https://github.com/danxexe/gb-rossetto-adventure/releases/download/v0.0.1-alpha/gb-rossetto-adventure.gb';
	...
	gameboys.push(new gb(romUrl, gbCanvas, {rootDir: "https://riperiperi.github.io/amebo/"}));
